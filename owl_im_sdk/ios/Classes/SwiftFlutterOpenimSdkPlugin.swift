...
public class SwiftOwlImSdkPlugin: NSObject, FlutterPlugin {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "owl_im_sdk", binaryMessenger: registrar.messenger())
        let instance = SwiftOwlImSdkPlugin(channel: channel)
