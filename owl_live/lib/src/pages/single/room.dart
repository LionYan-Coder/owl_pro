...
class _SingleRoomViewState extends SignalState<SingleRoomView> {
  ...
  void _setUpListeners() => _listener!
    ...
    ..on<LocalTrackPublishedEvent>((_) => _sortremoteParticipants())
    ..on<LocalTrackUnpublishedEvent>((_) => _sortremoteParticipants())
