      ...
      body: Stack(
        ...
        children: [
          ...
          BackdropFilter(
            ...
            child: Container(
              color: Color.fromRGBO(240, 249, 255, 0.6)
                  .adapterDark(Color.fromRGBO(13, 13, 13, 0.6)),
            ),
          ),
          Container(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  RippleEffectButton(),
                  48.gapv,
                  "chat_live_title".tr.toText
                    ..style = Styles.ts_FFFFFF_20_medium,
                  8.gapv,
                  Container(
                    ...
                    child: Center(
                      child: Row(
                        ...
                        children: [
                          "videocall_ico_request".svg.toSvg
                            ..width = 14.w
                            ..height = 14.w,
                          4.gaph,
                          "chat_live_hint".tr.toText
          ...
          Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.only(left: 16, top: 2).w,
                child: IconButton(
                    onPressed: () {
                      Get.snackbar(
                          "Warning", "Floating Window is not yet open");
                    },
              ...
              Container(
                margin: EdgeInsets.symmetric(
                    horizontal: 20.w,
                    vertical: context.mediaQueryPadding.bottom + 20.w),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
  ...
  Widget _button({required String icon, required bool on}) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border:
              Border.all(color: Styles.c_EDEDED.adapterDark(Styles.c_161616)),
  ...
  Widget _hungUpButton() {
    return ClipOval(
      child: Container(
        ...
        child: Center(
          child: "videocall_ico_end".svg.toSvg
            ..width = 24.w
            ..height = 24.w,
        ),
      ),
