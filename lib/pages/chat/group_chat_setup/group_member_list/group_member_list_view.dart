                    ...
                    child: Row(
                      children: [
                        AvatarView(
                          ...
                          height: 44.h,
                          text: '@',
                          textStyle: Styles.ts_FFFFFF_24,
                        ),
                        10.horizontalSpace,
                        StrRes.everyone.toText..style = Styles.ts_0C8CE9_14,
                      ],
                    ),
                  ),
                ),
        ...
        child: Row(
          ...
          children: [
            ...
            Button(
              ...
              textStyle: Styles.ts_FFFFFF_16,
              onPressed: logic.confirmSelectedMember,
            ),
          ],
        ),
      );
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  border: BorderDirectional(
                    bottom: BorderSide(color: Styles.c_0C8CE9, width: 1),
                  ),
                ),
                child: Row(
                  children: [
                    sprintf(StrRes.selectedPeopleCount,
                        [logic.checkedList.length]).toText
                      ..style = Styles.ts_0C8CE9_18_medium,
                    const Spacer(),
                    GestureDetector(
                      behavior: HitTestBehavior.translucent,
                      onTap: () => Get.back(),
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: StrRes.remove.toText..style = Styles.ts_0481DC_24,
              ),
            ),
          ],
        ),
