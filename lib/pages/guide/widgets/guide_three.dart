...
class GuideThree extends StatelessWidget {
  ...
  const GuideThree({super.key, required this.animationController});
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: "launchimage_img_three".png.toImage
                  ..width = 270.w
                  ..height = 270.w,
              ),
              Padding(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      "guide_three_title".tr.toText
                        ..style = Styles.ts_333333_24_bold
                            .adapterDark(Styles.ts_CCCCCC_24_bold)
                            .copyWith(letterSpacing: 5.w),
                      12.gapv,
                      "guide_three_text".tr.toText
