                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        10.horizontalSpace,
                        StrRes.selectAll.toText..style = Styles.ts_333333_18,
                      ],
                    ),
                  ),
                ),
          ...
          Flexible(
            child: Obx(
              () => WrapAzListView<ISUserInfo>(
                data: logic.friendList.skipWhile((e) => e.userID == null).toList(),
                itemCount: logic.friendList.length - 1,
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  10.horizontalSpace,
                  info.showName.toText..style = Styles.ts_0481DC_10,
                ],
              ),
            ),
          ),
